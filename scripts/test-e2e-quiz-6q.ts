...
function create6QuestionDirector(quiz: QuizV2) {
  ...
  const specs = [
    ...
    { archetype: "illustrated_multiple_choice" as const, palette_id: "pink" as const, layout_id: "media_top_choices_bottom" as const, motion_id: "enter.slideUp" as const },
    { archetype: "final_challenge" as const, palette_id: "aqua" as const, layout_id: "media_center_choices_side" as const, motion_id: "enter.scale" as const },
  ];
