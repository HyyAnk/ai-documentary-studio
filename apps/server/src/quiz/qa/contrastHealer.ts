...
export function generateContrastSelfHealingCss(report: HyperframesCheckReport | null): string {
  ...
  rules.push(
    ...
    ".answer-card span, .visual-answer-label span { color: #ffffff !important; text-shadow: 0 3px 0 rgba(0,0,0,0.35), 0 2px 8px rgba(0,0,0,0.4) !important; }",
    ".answer-card > b, .visual-answer-label > b { color: #ffffff !important; text-shadow: 0 4px 0 rgba(0,0,0,0.35), 0 2px 6px rgba(0,0,0,0.35) !important; }",
