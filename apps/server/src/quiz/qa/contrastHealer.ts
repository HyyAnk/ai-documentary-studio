...
export function generateContrastSelfHealingCss(report: HyperframesCheckReport | null): string {
  ...
  rules.push(
    ...
    ".answer-card > b, .visual-answer-label > b { color: #ffffff !important; -webkit-text-stroke: 4px var(--choice-stroke-shadow, #9A3412) !important; paint-order: stroke fill !important; }",
