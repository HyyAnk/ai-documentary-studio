...
@keyframes incorrect-card-settle { from { opacity: 1; transform: scale(1); } to { opacity: .52; transform: scale(.93); border-color: rgba(255,255,255,0.35); box-shadow: 0 4px 0 rgba(10,25,60,.12); } }
