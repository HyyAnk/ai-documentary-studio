...
export const QUIZ_STYLE_CONTRACTS: Record<QuizImageStyle, QuizStyleContract> = {
  pixar_3d: {
    ...
    renderingMedium: "high-end 3D animated movie render with rich tangible surface textures, tactile depth, and large expressive sparkling eyes",
    ...
    detailLevel: "masterpiece animated feature film standard with vibrant child-friendly appeal and high fidelity",
  ...
  flat_vector: {
    ...
    renderingMedium: "clean 2D vector graphic illustration with bold clean outlines, crisp shapes, and saturated flat pastel colors",
    ...
    detailLevel: "clean modern vector art designed for instant visual clarity and high aesthetic appeal",
    ...
    continuityPromptBrief: "modern 2D flat vector cartoon style, bold clean geometric outlines, bright flat pastel colors, playful minimalist design, vibrant layered vector backdrop, isolated centered subject",
  },
  kawaii_chibi: {
    id: "kawaii_chibi",
    ...
    detailLevel: "adorable simplified chibi proportions with high emotional charm and candy-like color harmony",
  ...
  voxel_lowpoly: {
    ...
    detailLevel: "playful stylized 3D cube pixels instantly appealing to kids with rich blocky detail",
    ...
    continuityPromptBrief: "3D colorful voxel blocky art style, vibrant cute cube pixels, clean isometric low-poly lighting, playful gaming aesthetic, lush voxel landscape backdrop with soft ambient lighting, isolated centered subject",
  },
  plastic_toy: {
    id: "plastic_toy",
    name: "3D Glossy Vinyl Toy",
    styleFamily: "3D glossy vinyl designer collectible toy",
    renderingMedium: "smooth glossy vinyl plastic toy figurine with specular shine, tactile toy proportions, and premium acrylic feel",
    ...
    detailLevel: "polished designer toy collectible aesthetic with clean form and glossy Pop Mart finish",
